...
class Matcher:
    ...
    def initialize_matcher():
        ...
        nombreLargo = ["PROPN", "DET", "ADP", "NOUN"] #podría hacer que tenga el numero opcional, pero luego si o si al final termine con PROPN (esta idea no dio buenos resultados)
        ...
        Matcher.matcher.add(
            "dir_nro",[ #direcciones platenses = numericas
                ...
                [{"LIKE_NUM": True},{"TEXT": {"IN": letraMay}, "OP":"?"},{"LOWER": "bis", "OP":"?"},{"LOWER": {"IN": conectores}},{"LOWER": {"IN":calleSinonimos3}, "OP":"?"},{"LIKE_NUM": True},{"TEXT": {"IN": letraMay}, "OP":"?"},{"LOWER":"bis", "OP":"?"},{"LOWER":{"IN":union}},{"LOWER": {"IN":calleSinonimos3}, "OP":"?"},{"LIKE_NUM": True},{"TEXT": {"IN": letraMay}, "OP":"?"},{"LOWER":"bis", "OP":"?"}],
                ...
                #[{"LOWER": {"IN":calleSinonimos3}},{"LIKE_NUM": True},{"TEXT": {"IN": letraMay}, "OP":"?"},{"LOWER":"bis", "OP":"?"},{"LOWER": {"IN":anteNumero}, "OP":"?"},{"LOWER": {"IN":numeroSinonimos2}, "OP":"?"},{"LIKE_NUM": True},{"LOWER": {"IN": conectores}},{"LOWER": {"IN":calleSinonimos3}, "OP":"?"},{"LOWER": {"IN":numeroSinonimos2}},{"LIKE_NUM":True},{"TEXT": {"IN": letraMay}, "OP":"?"},{"LOWER":"bis", "OP":"?"},{"LOWER":{"IN":union}},{"LOWER": {"IN":calleSinonimos3}, "OP":"?"},{"LIKE_NUM":True},{"LOWER": {"IN": letra}, "OP":"?"},{"LOWER":"bis", "OP":"?"}],
            ]
        )
        Matcher.matcher.add(
            ...
            [
                ...
                [{"LOWER": {"IN":calleSinonimos3}},{"POS":{"IN":nombreLargo}, "OP":"*"},{"POS": "PROPN"},{"LIKE_NUM": True, "OP": "?"},{"LOWER":"bis", "OP":"?"},{"LOWER": {"IN": conectores}},{"LOWER": {"IN":calleSinonimos3}, "OP":"?"},{"POS":{"IN":nombreLargo}, "OP":"*"},{"POS": "PROPN"},{"LOWER":"bis", "OP":"?"}], #no entinedo porque tengo que usar 'concectores' en lugar de 'union'
                ...
                #calle con altura
                [{"POS":{"IN":nombreLargo}, "OP":"+"},{"LIKE_NUM": True, "OP": "?"},{"LOWER":"bis"}],#un caso sin poner calle al inicio, no se si estoy overfitteando
                [{"POS":{"IN":nombreLargo}, "OP":"+"},{"LIKE_NUM": True, "OP": "?"},{"LOWER": "bis", "OP":"?"},{"LOWER": {"IN":numeroSinonimos2}},{"LIKE_NUM": True},],#otro caso sin poner calle al inicio, no se si estoy overfitteando
                
                [{"LOWER": {"IN":calleSinonimos3}},{"POS":{"IN":nombreLargo}, "OP":"+"},{"LIKE_NUM": True, "OP": "?"},{"LOWER": "bis", "OP":"?"},{"LOWER": {"IN":anteNumero}, "OP":"?"},{"LOWER": {"IN":numeroSinonimos2}, "OP":"?"},{"LIKE_NUM": True}],
                #[{"LOWER": {"IN":calleSinonimos3}},{"POS":{"IN":nombreLargo}, "OP":"+"},{"LIKE_NUM": True, "OP": "?"},{"LOWER": "bis", "OP":"?"},{"LOWER": {"IN":anteNumero}, "OP":"?"},{"LOWER": {"IN":numeroSinonimos2}, "OP":"?"},{"LIKE_NUM": True},{"LOWER": {"IN": union}},{"LOWER": {"IN":calleSinonimos3}, "OP":"?"},{"POS":{"IN":nombreLargo}, "OP":"+"},{"POS": "PROPN"},{"LOWER": "bis", "OP":"?"}],
                [{"LOWER": {"IN":calleSinonimos3}},{"POS":{"IN":nombreLargo}, "OP":"+"},{"LIKE_NUM": True, "OP": "?"},{"LOWER": "bis", "OP":"?"},{"LOWER": {"IN":anteNumero}, "OP":"?"},{"LOWER": {"IN":numeroSinonimos2}, "OP":"?"},{"LIKE_NUM": True},{"LOWER": {"IN": conectores}},{"LOWER": {"IN":calleSinonimos3}, "OP":"?"},{"POS":{"IN":nombreLargo}, "OP":"+"},{"LOWER": "bis", "OP":"?"},{"LOWER":{"IN":union}},{"LOWER": {"IN":calleSinonimos3}, "OP":"?"},{"POS":{"IN":nombreLargo}, "OP":"+"},{"LOWER": "bis", "OP":"?"}],#no entinedo porque debo sacarle el PROPN obligatorio del final
        ...
        Matcher.matcher.add(
            "dir_lote", [ #direccion de lote
                #[{"LOWER": "lote"}, {"LIKE_NUM":True},],#no se si lo debo incluir

                #manzana letrada
                [{"LOWER": "lote"}, {"LIKE_NUM":True},{"LOWER": {"IN": sobreSinonimos}, "OP":"?"},{"LOWER": {"IN": manzanaSinonimos2}},{"TEXT": {"IN": letraMay}}],
                [{"LOWER": {"IN": manzanaSinonimos2}},{"TEXT": {"IN": letraMay}}, {"LOWER": {"IN": sobreSinonimos}, "OP":"?"},{"LOWER": "lote"}, {"LIKE_NUM":True}],

                #manzana numerada
                [{"LOWER": "lote"}, {"LIKE_NUM":True},{"LOWER": {"IN": sobreSinonimos}, "OP":"?"},{"LOWER": {"IN": manzanaSinonimos2}},{"LOWER": {"IN":numeroSinonimos2}, "OP":"?"},{"LIKE_NUM": True}],
                [{"LOWER": {"IN": manzanaSinonimos2}},{"LOWER": {"IN":numeroSinonimos2}, "OP":"?"},{"LIKE_NUM": True}, {"LOWER": {"IN": sobreSinonimos}, "OP":"?"},{"LOWER": "lote"}, {"LIKE_NUM":True}],
            ]
        )
