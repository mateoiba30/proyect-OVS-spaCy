...
class Matcher:
    ...
    def initialize_matcher():
        ...
        conectores = ["e", "e/", "entre", "y", "a", "a/", "esquina"]
        union = ["y", "e"]
        ...
        Matcher.matcher.add(
            "dir_nro",[
                [{"LIKE_NUM": True}, {"POS": "ADJ"}, {"LIKE_NUM": True},{"TEXT":{"IN":union}}, {"LIKE_NUM": True}],
                [{"LOWER": {"IN":calleSinonimos2}},{'TEXT': '.', 'OP':'?'},{"LIKE_NUM": True},{"LOWER":"bis", "OP":"?"},{"LOWER": {"IN":numeroSinonimos2}, "OP":"?"},{"LIKE_NUM": True, "OP":"?"},{"LOWER": {"IN": conectores}, "OP":"+"},{"LIKE_NUM":True, "OP":"+"}],
                [{"LOWER": {"IN":calleSinonimos2}},{'TEXT': '.', 'OP':'?'},{"LIKE_NUM": True},{"LOWER":"bis", "OP":"?"},{"LOWER": {"IN":numeroSinonimos2}, "OP":"?"},{"LIKE_NUM": True, "OP":"?"},{"LOWER": {"IN": conectores}, "OP":"*"},{"LIKE_NUM":True, "OP":"?"},{"LOWER":"bis", "OP":"?"},{"TEXT":{"IN":union}},{"POS": "PROPN", "OP":"?"},{"LIKE_NUM": True, "OP":"+"}],
                [{"LOWER": {"IN":calleSinonimos2}},{'TEXT': '.', 'OP':'?'},{"LIKE_NUM": True},{"LOWER":"bis", "OP":"?"},{"LOWER": {"IN":numeroSinonimos2}, "OP":"?"},{"LIKE_NUM": True, "OP":"?"},{"LOWER": {"IN": conectores}, "OP":"*"},{"LIKE_NUM":True, "OP":"?"},{"LOWER":"bis", "OP":"?"},{"TEXT":{"IN":union}},{"POS": "PROPN", "OP":"?"},{"LIKE_NUM": True, "OP":"?"},{"LOWER":"bis", "OP":"?"},{"POS": "ADP", "OP": "*"},{"POS": "PROPN", "OP": "+"}],     
            ]
        )
        Matcher.matcher.add(
            "dir_interseccion",
            [
                ...
                [{"LOWER": {"IN":calleSinonimos2}},{'TEXT': '.', 'OP':'?'},{"POS":{"IN":nombreLargo}, "OP":"+"},{"LOWER": {"IN": conectores}},{"LEMMA": {"IN":calleSinonimos}, "OP":"?"},{'TEXT': '.', 'OP':'?'},{"POS":{"IN":nombreLargo}, "OP":"+"},{"TEXT":{"IN":union}},{"LOWER": {"IN":calleSinonimos2}, "OP":"?"},{'TEXT': '.', 'OP':'?'},{"POS":{"IN":nombreLargo}, "OP":"+"}, {"POS": "PROPN"}],
            ],
        )
        Matcher.matcher.add(
            "dir_entre", #los nuevos que agregué
            [
                [{"LOWER": {"IN":calleSinonimos2}},{'TEXT': '.', 'OP':'?'},{"LIKE_NUM": True},{"LOWER": "km"},{"LIKE_NUM": True}],
                ...
                #[{"LOWER": {"IN":calleSinonimos2}},{'TEXT': '.', 'OP':'?'},{"POS":{"IN":nombreLargo}, "OP":"+"},{"LOWER": {"IN": conectores}},{"LEMMA": {"IN":calleSinonimos}, "OP":"?"},{'TEXT': '.', 'OP':'?'},{"POS":{"IN":nombreLargo}, "OP":"+"},{"POS":"PROPN"}], #anda peor de lo esperado
        ...
        Matcher.matcher.add(
            "dir_lote", [ #otros nuevos patrones
