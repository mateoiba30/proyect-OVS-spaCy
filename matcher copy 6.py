    ...
    def initialize_matcher():
        ...
        Matcher.matcher.add(
            "dir_nro",[ #direcciones platenses = numericas
                ...
                [{"LOWER": {"IN":calleSinonimos3}},{"LIKE_NUM": True},{"LOWER":"bis", "OP":"?"},{"LOWER": {"IN": union}},{"LOWER": {"IN":calleSinonimos3}, "OP":"?"},{"LIKE_NUM":True},{"LOWER":"bis", "OP":"?"}],
                [{"LIKE_NUM": True},{"LOWER": "bis", "OP":"?"},{"LOWER": {"IN": conectores}},{"LOWER": {"IN":calleSinonimos3}, "OP":"?"},{"LIKE_NUM": True},{"LOWER":"bis", "OP":"?"},{"LOWER":{"IN":union}},{"LOWER": {"IN":calleSinonimos3}, "OP":"?"},{"LIKE_NUM": True},{"LOWER":"bis", "OP":"?"}],
                ...
                #[{"LOWER": {"IN":calleSinonimos3}},{"LIKE_NUM": True},{"LOWER":"bis", "OP":"?"},{"LOWER": {"IN":anteNumero}, "OP":"?"},{"LOWER": {"IN":numeroSinonimos2}, "OP":"?"},{"LIKE_NUM": True},{"LOWER": {"IN": conectores}},{"LOWER": {"IN":calleSinonimos3}, "OP":"?"},{"LOWER": {"IN":numeroSinonimos2}},{"LIKE_NUM":True},{"LOWER":"bis", "OP":"?"},{"LOWER":{"IN":union}},{"LOWER": {"IN":calleSinonimos3}, "OP":"?"},{"LIKE_NUM":True},{"LOWER":"bis", "OP":"?"}],
            ]
        )
        Matcher.matcher.add(
            ...
            [
                ...
                [{"LOWER": {"IN":calleSinonimos3}},{"POS":{"IN":nombreLargo}, "OP":"+"},{"LIKE_NUM": True, "OP": "?"},{"LOWER":"bis", "OP":"?"},{"LOWER": {"IN": conectores}},{"LOWER": {"IN":calleSinonimos3}, "OP":"?"},{"POS":{"IN":nombreLargo}, "OP":"+"},{"LOWER":"bis", "OP":"?"}], #no entinedo porque tengo que usar 'concectores' en lugar de 'union'
                [{"LOWER": {"IN":calleSinonimos3}},{"POS":{"IN":nombreLargo}, "OP":"+"},{"LIKE_NUM": True, "OP": "?"},{"LOWER": "bis", "OP":"?"},{"LOWER": {"IN": conectores}},{"LOWER": {"IN":calleSinonimos3}, "OP":"?"},{"POS":{"IN":nombreLargo}, "OP":"+"},{"LOWER": "bis", "OP":"?"},{"LOWER":{"IN":union}},{"LOWER": {"IN":calleSinonimos3}, "OP":"?"},{"POS":{"IN":nombreLargo}, "OP":"+"}, {"POS": "PROPN"}, {"LOWER": "bis", "OP":"?"},],
        ...
        Matcher.matcher.add(
            "dir_lote", [ #direccion de lote
                ...
                #manzana letrada
                [{"LOWER": "lote"}, {"POS": {"IN": nombreLote}},{"LOWER": {"IN": sobreSinonimos}, "OP":"?"},{"LOWER": {"IN": manzanaSinonimos2}},{"LOWER": {"IN":letra}}],
                [{"LOWER": {"IN": manzanaSinonimos2}},{"LOWER": {"IN":letra}}, {"LOWER": {"IN": sobreSinonimos}, "OP":"?"},{"LOWER": "lote"}, {"POS": {"IN": nombreLote}}],
