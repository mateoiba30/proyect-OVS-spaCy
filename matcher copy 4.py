...
class Matcher:
    ...
    def initialize_matcher():
        ...
        calleSinonimos3 = ["avs", "avs.", "av", "av.", "calle", "calles", "ruta", "rutas", "avenida", "avenidas", "diagonal", "diagonales", "dg", "dg.", "dgs", "dgs.", "diag", "diasg.", "diags", "diags"]
        ...
        Matcher.matcher.add(
            ...
            [
                [{"LOWER": {"IN":calleSinonimos3}},{"POS":{"IN":nombreLargo}, "OP":"+"},{"TEXT": "al", "OP":"?"},{"LIKE_NUM": True, "OP":"+"}],

                [{"LOWER": {"IN":calleSinonimos3}},{"POS":{"IN":nombreLargo}, "OP":"+"},{"LOWER": {"IN": conectores}},{"LOWER": {"IN":calleSinonimos3}, "OP":"?"},{"POS":{"IN":nombreLargo}, "OP":"+"},{"TEXT":{"IN":union}},{"LOWER": {"IN":calleSinonimos3}, "OP":"?"},{'TEXT': '.', 'OP':'?'},{"POS":{"IN":nombreLargo}, "OP":"+"}, {"POS": "PROPN"}],
                
                [{"POS":{"IN":nombreLargo}, "OP":"+"},{"LIKE_NUM": True, "OP": "?"},{"LOWER": "km"},{"LIKE_NUM": True}],
               #[{"LOWER": {"IN":calleSinonimos3}},{"POS":{"IN":nombreLargo}, "OP":"+"},{"TEXT":{"IN":union}},{"POS":{"IN":nombreLargo}, "OP":"+"}],#supuestamente baja presición, pero es culpa del header creo
                [{"LOWER": {"IN":calleSinonimos3}},{"POS":{"IN":nombreLargo}, "OP":"+"},{"LOWER": {"IN": conectores}},{"POS":{"IN":nombreLargo}, "OP":"+"},{"TEXT":{"IN":union}},{"POS":{"IN":nombreLargo}, "OP":"+"}, {"POS": "PROPN"}],#no me modifica la precisión 
               #[{"LOWER": {"IN":calleSinonimos3}},{"POS":{"IN":nombreLargo}, "OP":"+"},{"TEXT": "al", "OP":"?"},{"LIKE_NUM": True, "OP":"+"},{"LOWER": {"IN": conectores}},{"POS":{"IN":nombreLargo}, "OP":"+"},{"TEXT":{"IN":union}},{"POS":{"IN":nombreLargo}, "OP":"+"}, {"POS": "PROPN"}], #el de abajo hace lo mismo pero mejor (tal vez en una db grande convenga el de esta línea)
               ...
               #[{"LOWER": {"IN":calleSinonimos3}},{"POS":{"IN":nombreLargo}, "OP":"+"},{"LOWER": {"IN": conectores}},{"LOWER": {"IN":calleSinonimos3}, "OP":"?"},{"POS":{"IN":nombreLargo}, "OP":"+"},{"POS":"PROPN"}], #anda peor de lo esperado
                ...
                [{"LOWER": {"IN":calleSinonimos3}},{"POS":{"IN":nombreLargo}, "OP":"+"},{"LOWER": {"IN": conectores}},{"POS":"DET", "OP":"?"},{"LOWER": {"IN":calleSinonimos3}},{"TEXT":{"IN":union}},{"POS":{"IN":nombreLargo}, "OP":"+"}, {"POS": "PROPN"}],#no matchea lo que quiero
