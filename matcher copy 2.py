...
class Matcher:
    ...
    def initialize_matcher():
        ...
        Matcher.matcher.add( #LOS PATRONES COMENTADOS sin explicación es porque no aportan precisión, pero en una db más grande tal vez si
            "dir_nro",[ #direcciones platenses = numericas
                #[{"LOWER": {"IN":calleSinonimos2}},{'TEXT': '.', 'OP':'?'},{"LIKE_NUM": True}, {"LOWER": "bis", "OP":"?"}], #baja precisión
                [{"LOWER": {"IN":calleSinonimos2}},{'TEXT': '.', 'OP':'?'},{"LIKE_NUM": True},{"LOWER":"bis", "OP":"?"},{"LOWER": {"IN": conectores}},{"LIKE_NUM":True}], #baja precisión
                [{"LIKE_NUM": True},{"LOWER": "bis", "OP":"?"},{"LOWER": {"IN": conectores}},{"LIKE_NUM": True},{"TEXT":{"IN":union}}, {"LIKE_NUM": True}],

                [{"LOWER": {"IN":calleSinonimos2}},{'TEXT': '.', 'OP':'?'},{"LIKE_NUM": True},{"LOWER":"bis"}], #no aporta nada, pero lo dejo porque tal vez en una db más grande si lo haga
                #[{"LOWER": {"IN":calleSinonimos2}},{'TEXT': '.', 'OP':'?'},{"LIKE_NUM": True},{"LOWER":"bis"},{"LOWER": {"IN": conectores}}, {"LIKE_NUM": True}],
                [{"LOWER": {"IN":calleSinonimos2}},{'TEXT': '.', 'OP':'?'},{"LIKE_NUM": True},{"LOWER":"bis"},{"LOWER": {"IN": conectores}}, {"LIKE_NUM": True},{"TEXT":{"IN":union}}, {"LIKE_NUM": True}],
                ...
                [{"LOWER": {"IN":calleSinonimos2}},{'TEXT': '.', 'OP':'?'},{"LIKE_NUM": True},{"LOWER":"bis", "OP":"?"},{"LOWER": {"IN":anteNumero}, "OP":"?"},{"LOWER": {"IN":numeroSinonimos2}, "OP":"?"},{"LIKE_NUM": True},{"LOWER": {"IN": conectores}},{"LOWER": {"IN":numeroSinonimos2}},{"LIKE_NUM":True}],
                #[{"LOWER": {"IN":calleSinonimos2}},{'TEXT': '.', 'OP':'?'},{"LIKE_NUM": True},{"LOWER":"bis", "OP":"?"},{"LOWER": {"IN":anteNumero}, "OP":"?"},{"LOWER": {"IN":numeroSinonimos2}, "OP":"?"},{"LIKE_NUM": True},{"LOWER": {"IN": conectores}},{"LOWER": {"IN":numeroSinonimos2}},{"LIKE_NUM":True},{"TEXT":{"IN":union}},{"LIKE_NUM":True}],
            ]
        )
        Matcher.matcher.add(
