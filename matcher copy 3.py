...
class Matcher:
    ...
    def initialize_matcher():
        ...
        conectores = ["e/", "entre", "a", "a/", "esquina"]
        union = ["y", "e"]
        ...
        Matcher.matcher.add(
            "dir_nro",[ #direcciones platenses = numericas
                #[{"LOWER": {"IN":calleSinonimos2}},{'TEXT': '.', 'OP':'?'},{"LOWER": {"IN":calleSinonimos2}, "OP":"?"},{"LIKE_NUM": True},{"LOWER": "bis", "OP":"?"}], #baja precisión
                [{"LOWER": {"IN":calleSinonimos2}},{'TEXT': '.', 'OP':'?'},{"LOWER": {"IN":calleSinonimos2}, "OP":"?"},{"LIKE_NUM": True},{"LOWER":"bis", "OP":"?"},{"LOWER": {"IN": conectores}},{"LIKE_NUM":True}],
                [{"LIKE_NUM": True},{"LOWER": "bis", "OP":"?"},{"LOWER": {"IN": conectores}},{"LOWER": {"IN":calleSinonimos2}, "OP":"?"},{"LIKE_NUM": True},{"TEXT":{"IN":union}},{"LOWER": {"IN":calleSinonimos2}, "OP":"?"},{"LIKE_NUM": True}],

                #[{"LOWER": {"IN":calleSinonimos2}},{'TEXT': '.', 'OP':'?'},{"LIKE_NUM": True},{"LOWER":"bis"}],
                #[{"LOWER": {"IN":calleSinonimos2}},{'TEXT': '.', 'OP':'?'},{"LIKE_NUM": True},{"LOWER":"bis"},{"LOWER": {"IN": conectores}}, {"LIKE_NUM": True}],
                [{"LOWER": {"IN":calleSinonimos2}},{'TEXT': '.', 'OP':'?'},{"LIKE_NUM": True},{"LOWER":"bis"},{"LOWER": {"IN": conectores}},{"LOWER": {"IN":calleSinonimos2}, "OP":"?"},{"LIKE_NUM": True},{"TEXT":{"IN":union}},{"LOWER": {"IN":calleSinonimos2}, "OP":"?"},{"LIKE_NUM": True}],

                [{"LOWER": {"IN":calleSinonimos2}},{'TEXT': '.', 'OP':'?'},{"LIKE_NUM": True},{"LOWER":"bis", "OP":"?"},{"LOWER": {"IN":anteNumero}, "OP":"?"},{"LOWER": {"IN":numeroSinonimos2}, "OP":"?"},{"LIKE_NUM": True}],
                [{"LOWER": {"IN":calleSinonimos2}},{'TEXT': '.', 'OP':'?'},{"LIKE_NUM": True},{"LOWER":"bis", "OP":"?"},{"LOWER": {"IN":anteNumero}, "OP":"?"},{"LOWER": {"IN":numeroSinonimos2}, "OP":"?"},{"LIKE_NUM": True},{"LOWER": {"IN": conectores}},{"LOWER": {"IN":calleSinonimos2}, "OP":"?"},{"LOWER": {"IN":numeroSinonimos2}},{"LIKE_NUM":True}],
                #[{"LOWER": {"IN":calleSinonimos2}},{'TEXT': '.', 'OP':'?'},{"LIKE_NUM": True},{"LOWER":"bis", "OP":"?"},{"LOWER": {"IN":anteNumero}, "OP":"?"},{"LOWER": {"IN":numeroSinonimos2}, "OP":"?"},{"LIKE_NUM": True},{"LOWER": {"IN": conectores}},{"LOWER": {"IN":calleSinonimos2}, "OP":"?"},{"LOWER": {"IN":numeroSinonimos2}},{"LIKE_NUM":True},{"TEXT":{"IN":union}},{"LOWER": {"IN":calleSinonimos2}, "OP":"?"},{"LIKE_NUM":True}],
            ]
        )
        Matcher.matcher.add(
            ...
            [
                ...
                [{"LOWER": {"IN":calleSinonimos2}},{'TEXT': '.', 'OP':'?'},{"POS":{"IN":nombreLargo}, "OP":"+"},{"LOWER": {"IN": conectores}},{"LOWER": {"IN":calleSinonimos2}, "OP":"?"},{'TEXT': '.', 'OP':'?'},{"POS":{"IN":nombreLargo}, "OP":"+"},{"TEXT":{"IN":union}},{"LOWER": {"IN":calleSinonimos2}, "OP":"?"},{'TEXT': '.', 'OP':'?'},{"POS":{"IN":nombreLargo}, "OP":"+"}, {"POS": "PROPN"}],
                [{"POS":{"IN":nombreLargo}, "OP":"+"},{"LIKE_NUM": True, "OP": "?"},{"LOWER": "km"},{"LIKE_NUM": True}],
                #[{"LOWER": {"IN":calleSinonimos2}},{'TEXT': '.', 'OP':'?'},{"POS":{"IN":nombreLargo}, "OP":"+"},{"TEXT":{"IN":union}},{"POS":{"IN":nombreLargo}, "OP":"+"}],#supuestamente baja presición, pero es culpa del header creo
                [{"LOWER": {"IN":calleSinonimos2}},{'TEXT': '.', 'OP':'?'},{"POS":{"IN":nombreLargo}, "OP":"+"},{"LOWER": {"IN": conectores}},{"POS":{"IN":nombreLargo}, "OP":"+"},{"TEXT":{"IN":union}},{"POS":{"IN":nombreLargo}, "OP":"+"}, {"POS": "PROPN"}],#no me modifica la precisión 
                #[{"LOWER": {"IN":calleSinonimos2}},{'TEXT': '.', 'OP':'?'},{"POS":{"IN":nombreLargo}, "OP":"+"},{"TEXT": "al", "OP":"?"},{"LIKE_NUM": True, "OP":"+"},{"LOWER": {"IN": conectores}},{"POS":{"IN":nombreLargo}, "OP":"+"},{"TEXT":{"IN":union}},{"POS":{"IN":nombreLargo}, "OP":"+"}, {"POS": "PROPN"}], #el de abajo hace lo mismo pero mejor (tal vez en una db grande convenga el de esta línea)
                [{"POS":{"IN":nombreLargo}, "OP":"+"},{"TEXT": "al", "OP":"?"},{"LIKE_NUM": True, "OP":"+"},{"LOWER": {"IN": conectores}},{"POS":{"IN":nombreLargo}, "OP":"+"},{"TEXT":{"IN":union}},{"POS":{"IN":nombreLargo}, "OP":"+"}],
                [{"POS":{"IN":nombreLargo}, "OP":"+"},{"LOWER": {"IN":numeroSinonimos2}},{"LIKE_NUM": True}],
                #[{"LOWER": {"IN":calleSinonimos2}},{'TEXT': '.', 'OP':'?'},{"POS":{"IN":nombreLargo}, "OP":"+"},{"LOWER": {"IN": conectores}},{"LOWER": {"IN":calleSinonimos2}, "OP":"?"},{'TEXT': '.', 'OP':'?'},{"POS":{"IN":nombreLargo}, "OP":"+"},{"POS":"PROPN"}], #anda peor de lo esperado
                [{"LOWER": {"IN":calleSinonimos2}},{'TEXT': '.', 'OP':'?'},{"POS":{"IN":nombreLargo}, "OP":"+"},{"LOWER": {"IN":numeroSinonimos2}, "OP":"?"},{"LIKE_NUM": True}], #no mejora la presición
                [{"LOWER": {"IN":calleSinonimos2}},{'TEXT': '.', 'OP':'?'},{"POS":{"IN":nombreLargo}, "OP":"+"},{"LOWER": {"IN":numeroSinonimos2}, "OP":"?"},{"LIKE_NUM": True},{"LOWER": {"IN": conectores}},{"POS":{"IN":nombreLargo}, "OP":"+"},{"TEXT":{"IN":union}},{"POS":{"IN":nombreLargo}, "OP":"+"}, {"POS": "PROPN"}],#debo mejorar el helper para este
                [{"LOWER": {"IN":calleSinonimos2}},{'TEXT': '.', 'OP':'?'},{"POS":{"IN":nombreLargo}, "OP":"+"},{"LOWER": {"IN": conectores}},{"POS":"DET", "OP":"?"},{"LOWER": {"IN":calleSinonimos2}},{'TEXT': '.', 'OP':'?'},{"TEXT":{"IN":union}},{"POS":{"IN":nombreLargo}, "OP":"+"}, {"POS": "PROPN"}],#no matchea lo que quiero
        ...
        Matcher.matcher.add(
            ...
            [
                ...
                [{"LOWER": {"IN":calleSinonimos2}},{'TEXT': '.', 'OP':'?'},{"LIKE_NUM": True},{"LOWER":"bis", "OP":"?"},{"LOWER": {"IN":anteNumero}, "OP":"?"},{"LOWER": {"IN":numeroSinonimos2}, "OP":"?"},{"LIKE_NUM": True},{"LOWER": {"IN": conectores}, "OP":"*"},{"LIKE_NUM":True},{"LOWER":"bis", "OP":"?"},{"TEXT":{"IN":union}},{"POS": "PROPN", "OP":"?"},{"LIKE_NUM": True, "OP":"+"}],
                [{"LOWER": {"IN":calleSinonimos2}},{'TEXT': '.', 'OP':'?'},{"LIKE_NUM": True},{"LOWER":"bis", "OP":"?"},{"LOWER": {"IN":anteNumero}, "OP":"?"},{"LOWER": {"IN":numeroSinonimos2}, "OP":"?"},{"LIKE_NUM": True, "OP":"?"},{"LOWER": {"IN": conectores}, "OP":"*"},{"LIKE_NUM":True, "OP":"?"},{"LOWER":"bis", "OP":"?"},{"TEXT":{"IN":union}},{"POS": "PROPN", "OP":"?"},{"LIKE_NUM": True, "OP":"?"},{"LOWER":"bis", "OP":"?"},{"POS": "ADP", "OP": "*"},{"POS": "PROPN", "OP": "+"}],                     
                [{"LOWER": {"IN":calleSinonimos2}},{'TEXT': '.', 'OP':'?'},{"LIKE_NUM": True},{"LOWER":"bis", "OP":"?"},{"LOWER": {"IN":anteNumero}, "OP":"?"},{"LOWER": {"IN":numeroSinonimos2}, "OP":"?"},{"LIKE_NUM": True, "OP":"?"},{"LOWER": {"IN": conectores}, "OP":"*"},{"LIKE_NUM":True, "OP":"?"},{"LOWER":"bis", "OP":"?"},{"TEXT":{"IN":union}},{"POS": "PROPN", "OP":"?"},{"LIKE_NUM": True, "OP":"+"}],
            ],
        )
        Matcher.matcher.add(
            "dir_lote", [ #direccion de lote
                ...
                [{"LOWER": "lote"}, {"POS": {"IN": ["NUM", "PROPN"]}}, {"LOWER": {"IN": ["en","sobre"]}, "OP":"?"}, {"LOWER": {"IN": manzanaSinonimos2}},{"POS":"CCONJ"}],#"manzana E" en lugar de "manzana 5"
                [{"LOWER": {"IN": manzanaSinonimos2}},{"POS":"CCONJ"}, {"LOWER": {"IN": ["en","sobre"]}, "OP":"?"},{"LOWER": "lote"}, {"POS": {"IN": ["NUM", "PROPN"]}}],
            ]
        )
